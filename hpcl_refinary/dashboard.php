                        ...
                        <section class="section">
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <?php 
// $sql ="SELECT refinary_id from  refinary ";
// $query = $conn -> prepare($sql);
// $query->execute();
// $results=$query->fetchAll(PDO::FETCH_OBJ);
// $totalsubjects=$query->rowCount();
?>
                                            <span class="number counter">7</span>
                                    ...
                                    <a class="dashboard-stat bg-warning" href="manage-refinary.php">
                                    <?php 
$sql2 ="SELECT refinary_id from  refinary where delete_status!='9';";
$query2 = mysqli_query($conn, $sql2);
//$results2 = mysqli_fetch_assoc($query2);

$totalrefinary=mysqli_num_rows($query2);
//if($totalrefinary)
//echo "OMG";
...
?>
                                            <span class="number counter"><?php echo $totalrefinary;?></span>
                                            <span class="name">Total refinaries listed</span>
