                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Refinary</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="create-refinary.php"><i class="fa fa-bars"></i> <span>Create Refinary</span></a></li>
                                            <li><a href="manage-refinary.php"><i class="fa fa fa-server"></i> <span>Manage Refinary</span></a></li>
